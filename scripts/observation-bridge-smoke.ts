...
assert.match(catWindow, /function sendCatObservationReaction/)
assert.match(catWindow, /did-finish-load/)
assert.match(catWindow, /function syncCatBubbleWindowState/)
assert.match(catWindow, /Cat observation reaction could not show bubble/)
assert.match(viteConfig, /cat-bubble\.html/)
