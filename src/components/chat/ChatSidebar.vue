...
<template>
  ...
  >
    ...
    <SidebarFooter
      class="group/footer group-data-[collapsible=icon]:w-(--sidebar-width-icon) group-data-[collapsible=icon]:overflow-hidden group-data-[collapsible=icon]:bg-transparent group-data-[collapsible=icon]:transition-[width,background-color,box-shadow] group-data-[collapsible=icon]:duration-200 group-data-[collapsible=icon]:ease-out group-data-[collapsible=icon]:hover:w-(--sidebar-width) group-data-[collapsible=icon]:hover:rounded-r-lg group-data-[collapsible=icon]:hover:bg-sidebar group-data-[collapsible=icon]:hover:shadow-lg group-data-[collapsible=icon]:hover:ring-1 group-data-[collapsible=icon]:hover:ring-sidebar-border group-data-[collapsible=icon]:focus-within:w-(--sidebar-width) group-data-[collapsible=icon]:focus-within:rounded-r-lg group-data-[collapsible=icon]:focus-within:bg-sidebar group-data-[collapsible=icon]:focus-within:shadow-lg group-data-[collapsible=icon]:focus-within:ring-1 group-data-[collapsible=icon]:focus-within:ring-sidebar-border group-data-[collapsible=icon]:has-data-[state=open]:w-(--sidebar-width) group-data-[collapsible=icon]:has-data-[state=open]:rounded-r-lg group-data-[collapsible=icon]:has-data-[state=open]:bg-sidebar group-data-[collapsible=icon]:has-data-[state=open]:shadow-lg group-data-[collapsible=icon]:has-data-[state=open]:ring-1 group-data-[collapsible=icon]:has-data-[state=open]:ring-sidebar-border"
    >
      <SidebarMenu>
