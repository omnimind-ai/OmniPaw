export default {
  ...
  catPet: {
    ...
    moodSummary: {
      angry: '现在有点炸毛，低风险互动更容易安抚它。',
      sad: '看起来有点伤心，陪陪它会好一些。',
      down: '有些失落，可以试着轻轻互动。',
      normal: '状态稳定，适合日常互动。',
      happy: '心情不错，回应会更轻快。',
      attached: '非常亲近，会更愿意黏着你。',
    },
    away: {
    ...
    action: {
      ...
      teaseHint: '逗逗猫咪',
      feedHint: '给猫咪一点小零食',
      custom_lowHint: '温和地安抚一下',
      custom_mediumHint: '来一次更有存在感的互动',
      custom_highHint: '高收益但更容易惹毛它',
      defaultHint: '和猫咪互动一下',
    ...
    feedback: {
      ...
      teaseNegative: '猫咪生气了',
      feedPositive: '猫咪开心地收下了小零食',
      feedNegative: '猫咪现在没什么胃口',
      positive: '{action}让猫咪开心了一点',
      negative: '{action}没有达到预期',
    },
    config: {
      button: '配置',
      title: '自定义互动',
      description:
        '三个槽位分别对应低、中、高风险；风险越高，成功时好感和心情提升越大，失败时也更容易受影响。',
      effect: {
        low: '小幅提升',
        medium: '中等提升',
        high: '高提升',
