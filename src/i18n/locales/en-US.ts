export default {
  settings: {
    ...
    observation: {
      ...
      immediateObserve: 'Observe and test reply',
      ...
      errors: {
        ...
        triggerFailed: 'Failed to test the vision observation reply.',
    ...
    omniInfer: {
      ...
      backends: {
        ...
        description: 'Choose the backend OmniInfer currently uses for local inference.',
        current: 'In use',
        currentDescription: 'Currently used for local inference',
        currentEmpty: 'Not selected',
        currentEmptyDescription: 'Start the gateway, then choose an inference backend',
        switchTitle: 'Switch inference backend',
        switchDescription:
          'These backends support the current device. Missing local resources can be downloaded.',
        availableDescription: 'Local resources are ready and this backend can be used.',
        downloadDescription: 'Download the required resources before using this backend.',
        gatewayRequired: 'Start the gateway before switching to this backend.',
        emptyTitle: 'No backends found',
        emptyDescription: 'Check the OmniInfer directory configuration, then refresh the list.',
      },
      actions: {
        refresh: 'Refresh',
        start: 'Start service',
      ...
      messages: {
        ...
        installCompleted: '{backend} download completed.',
        installFailed: 'Failed to download the inference backend.',
        selectCompleted: '{backend} is now used for local inference.',
        selectFailed: 'Failed to switch the inference backend.',
    ...
    provider: {
      ...
      models: {
        ...
        download: {
          openButton: 'Download Models',
          title: 'Download Local Models',
          description: 'Get GGUF models from the OmniCore catalog or Hugging Face.',
          close: 'Close',
          sources: {
            omniCore: 'OmniCore',
          ...
          search: 'Search',
          searchPlaceholder: 'Search by model name, author, or tag',
          refresh: 'Refresh model catalog',
          catalogLoadFailed: 'Failed to load the model catalog',
          emptyTitle: 'No models found',
          emptyDescription: 'Adjust the search or refresh the current source.',
          viewDetails: 'View Details',
          backToCatalog: 'Back to Model Catalog',
          variantsTitle: 'Downloadable Files',
          variantsDescription: 'Choose a quantization from {count} available files.',
          variantsFound: '{count} downloadable files',
          quantization: 'Select quantization',
          sizeGiB: '{size} GiB',
          sizeUnknown: 'Unknown size',
          downloadCount: '{count} downloads',
          likeCount: '{count} likes',
          lastModified: 'Updated {date}',
          contextLength: '{count} token context',
          fileCount: '{count} shards',
          unnamedFile: 'Unnamed file',
          recommended: 'Recommended',
          notRecommended: 'Device resources may be insufficient',
          requiredMemory: 'About {size} GiB memory required',
          visionCompanion: 'The vision companion file will be downloaded with the model',
          vision: 'Vision',
          thinking: 'Thinking',
          download: 'Download',
          cancel: 'Cancel',
          ...
          started: 'Started downloading {model}.',
          completed: '{model} finished downloading.',
          startFailed: 'Failed to start the model download.',
      ...
      omniInfer: {
        ...
        modelsDirDescription:
          'New downloads and scans use this directory. To add a model manually, copy its .gguf file here.',
        ...
        selectInstallDirAria: 'Select OmniInfer install directory',
        openInstallDirAria: 'Open OmniInfer install directory',
        selectModelsDirAria: 'Select model download directory',
        openModelsDirAria: 'Open model download directory',
      ...
      messages: {
        ...
        openDirectoryFailed: 'Failed to open OmniInfer directory.',
  ...
  chat: {
    ...
    composer: {
      ...
      capabilityMentionsAria: 'Referenced capabilities',
      removeCapabilityMentionAria: 'Remove capability reference: {capability}',
      switchModelAria: 'Switch model: {model}',
      switchModel: 'Switch model',
      agentPermissionAria: 'Agent permission: {description}',
      agentPermission: 'Agent permission',
      slashMenu: {
        ariaLabel: 'Capability reference menu',
        groups: {
          skill: 'Skills',
          mcp: 'MCP',
        },
        ...
        mcpUnavailable: 'The MCP tool list is temporarily unavailable',
        skillDescriptionFallback: 'Use this skill for the message',
        mcpDescriptionFallback: 'Use this MCP tool for the message',
      },
      attachmentPresets: {
        image: {
          describe: {
