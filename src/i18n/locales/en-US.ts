export default {
  ...
  catPet: {
    ...
    moodSummary: {
      angry: 'A little irritated. Low-risk interactions are safer now.',
      sad: 'Feeling sad. Gentle company should help.',
      down: 'A bit down. Try a soft interaction.',
      normal: 'Stable and ready for everyday interaction.',
      happy: 'In a good mood, so replies feel lighter.',
      attached: 'Very attached and more openly affectionate.',
    },
    away: {
    ...
    action: {
      ...
      tease: 'Tease',
      feed: 'Feed',
      custom_low: 'Soft praise',
      custom_medium: 'Play together',
      custom_high: 'Surprise challenge',
      remaining: '{count} left',
      patHint: 'Give the cat a gentle pat',
      teaseHint: 'Tease the cat',
      feedHint: 'Offer the cat a small treat',
      custom_lowHint: 'Soothe it gently',
      custom_mediumHint: 'Try a more active interaction',
      custom_highHint: 'High reward, but easier to annoy it',
    ...
    feedback: {
      ...
      feedPositive: 'The cat happily accepts the treat',
      feedNegative: "The cat isn't hungry right now",
      positive: '{action} cheered the cat up',
      negative: "{action} didn't land well",
    },
    config: {
      button: 'Configure',
      title: 'Custom interactions',
      description:
        'The three slots map to low, medium, and high risk. Higher risk gives more affection and mood on success, but hurts more on failure.',
      effect: {
        low: 'Small gain',
        medium: 'Medium gain',
        high: 'High gain',
